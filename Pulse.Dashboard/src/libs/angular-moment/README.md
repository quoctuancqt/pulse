...
* From a CDN: [jsDelivr](https://cdn.jsdelivr.net/angular.moment/1.0.0/angular-moment.min.js) or [CDNJS](https://cdnjs.cloudflare.com/ajax/libsangular-moment/1.0.0/angular-moment.min.js)
